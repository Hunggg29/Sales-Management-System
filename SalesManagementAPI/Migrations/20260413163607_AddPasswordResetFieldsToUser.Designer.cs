...
namespace SalesManagementAPI.Migrations
{
    ...
    [Migration("20260413163607_AddPasswordResetFieldsToUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalesManagementAPI.Models.CartItem", b =>
                {
            ...
            modelBuilder.Entity("SalesManagementAPI.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("ResetPasswordTokenUsedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SalesManagementAPI.Models.Cart", b =>
                {
                    b.HasOne("SalesManagementAPI.Models.Customer", "Customer")
                        .WithOne("Cart")
                        .HasForeignKey("SalesManagementAPI.Models.Cart", "CustomerID")
            ...
            modelBuilder.Entity("SalesManagementAPI.Models.CartItem", b =>
                {
                    b.HasOne("SalesManagementAPI.Models.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("SalesManagementAPI.Models.Invoice", b =>
                {
                    ...
                    b.HasOne("SalesManagementAPI.Models.Employee", "Staff")
                        .WithMany("Invoices")
