...
namespace SalesManagementAPI.Libraries
{
    public class VnPayLibrary
    {
        ...
        private string GetResponseData()
        {
            ...
            {
                // KHÔNG URL encode khi validate signature
...
public class VnPayCompare : IComparer<string>
{
    public int Compare(string x, string y)
    {
        ...
        return vnpCompare.Compare(x, y, CompareOptions.OrdinalIgnoreCase);
    }
}
